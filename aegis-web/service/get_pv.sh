...
node /data/badjs-ivweb/aegis-web/service/handle_pv.js ${logs_file} $(date -d "yesterday" +"%Y%m%d")
node /data/badjs-ivweb/aegis-web/service/handle_pv_log.js ${logs_file_log} $(date -d "yesterday" +"%Y%m%d")
